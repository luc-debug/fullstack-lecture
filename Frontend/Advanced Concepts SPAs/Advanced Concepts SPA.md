...
|               | Library                           | Framework                                                 |
| ------------- | --------------------------------- | --------------------------------------------------------- |
| **Kontrolle** | Sie rufen die Library auf        | Das Framework ruft Ihren Code auf (Inversion of Control)  |
...
> 💡 Merke: Bei einer Library haben **Sie** die Kontrolle. Bei einem Framework hat das **Framework** die Kontrolle (Inversion of Control).
...
- Frameworks können natürlich auch alles, was ein Build-Tool kann. Recap:
